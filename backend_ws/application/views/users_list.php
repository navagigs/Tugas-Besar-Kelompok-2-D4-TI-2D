    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('users/read/'.$users->),'Read'); 
				echo ' | '; 
				echo anchor(site_url('users/update/'.$users->),'Update'); 
				echo ' | '; 
				echo anchor(site_url('users/delete/'.$users->),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
